  ...
  return (
    <div className="rounded-2xl border border-zinc-200/90 dark:border-zinc-700/80 bg-white dark:bg-gray-900 shadow-xl shadow-zinc-200/20 dark:shadow-none p-6 sm:p-8">
      <div className="space-y-3">
        ...
        >
          {oauthLoading === 'google' ? <Loader2 className="mr-3 h-5 w-5 animate-spin" /> : <GoogleIcon className="mr-3 h-5 w-5 shrink-0" />}
        ...
        <Button
          ...
          disabled={!!oauthLoading || magicLinkLoading}
        >
          {oauthLoading === 'facebook' ? <Loader2 className="mr-3 h-5 w-5 animate-spin" /> : <FacebookIcon className="mr-3 h-5 w-5 shrink-0" />}
      ...
      {isMagicLink ? (
        <form onSubmit={handleMagicLinkSubmit} className="space-y-4">
          ...
          {error && (
            <div className="text-sm text-red-700 bg-red-50 p-3 rounded-xl border border-red-200">
              <p>{error}</p>
            </div>
          )}
          <Button
            ...
            disabled={magicLinkLoading || !!oauthLoading}
          >
