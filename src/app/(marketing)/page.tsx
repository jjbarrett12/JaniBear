    ...
    <div className="landing-page min-h-screen text-white pb-20 md:pb-0">
      ...
      <nav className={navClassName}>
        <div className="container relative mx-auto px-4 h-full flex items-center justify-between gap-4 min-h-0">
          ...
          {/* Desktop: Sign in — use relative path so it always resolves to current origin */}
        ...
        >
          ...
          <div className="absolute top-0 right-0 bottom-0 w-full max-w-sm bg-black border-l border-amber-400/30 shadow-xl flex flex-col">
            ...
            <nav className="flex flex-col p-4 gap-1">
              ...
              <Link href="/auth/login" onClick={() => setMenuOpen(false)} className="px-3 py-3 text-zinc-400 text-sm hover:text-white hover:bg-white/10 rounded-lg mt-2 block">
                Sign in
              </Link>
            </nav>
          </div>
      ...
      {/* 1. HERO — lighter overlays so backdrop stays visible */}
      <section className="relative w-full overflow-hidden pt-8 md:pt-10 pb-10 md:pb-12 flex flex-col" aria-labelledby="hero-heading">
        ...
        <div className="relative container mx-auto px-4 max-w-6xl flex flex-col items-center pt-0 md:pt-1">
          <h1 id="hero-heading" className="text-center max-w-4xl mx-auto font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight hero-headline">
