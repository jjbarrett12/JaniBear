...
export function HeroCenterImage() {
  ...
  return (
    <>
      <div className="absolute -inset-8 bg-amber-400/15 rounded-3xl blur-3xl" aria-hidden />
      <div className="relative w-[520px] sm:w-[640px] md:w-[780px] lg:w-[900px] xl:w-[1000px] drop-shadow-[0_8px_48px_rgba(0,0,0,0.5)]">
        <Image
          src={src}
