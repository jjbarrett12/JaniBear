      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-6 py-4">
        ...
        {rows.length === 0 ? (
          <div className="rounded-lg border border-dashed border-border bg-muted/20 p-8 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">No recurring revenue scheduled for today.</p>
            <Link href="/app/reports/revenue">
              <Button variant="outline" size="sm" className="mt-4">View revenue report</Button>
            </Link>
          </div>
        ) : (
