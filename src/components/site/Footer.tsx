...
const BRAND_DESCRIPTION =
  'JANIBEAR is the operating system for commercial cleaning: win bids with walkthrough-to-proposal workflows, keep accounts with inspections and proof of work, and protect margin with real visibility.';
      ...
      <div className="mx-auto max-w-7xl px-6 py-14 md:py-20">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link
              href="/"
              className="inline-block focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 rounded"
            >
              <Image
                src="/logo.png"
                alt="JANIBEAR"
                  ...
                  <li key={link.href + link.label}>
                    {link.external ? (
                      <a
                        ...
                        className="text-base text-zinc-400 transition-colors hover:text-white focus:outline-none focus-visible:underline"
                      >
                        {link.label}
                      </a>
                    ) : (
